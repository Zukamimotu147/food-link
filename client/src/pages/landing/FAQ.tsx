          ...
          <Accordion type="single" collapsible className="mt-12">
            <AccordionItem value="item-1">
              ...
              <AccordionContent className="mt-4 sm:mt-6 text-base sm:text-lg">
                ...
                to a charity based on their needs and location. We’ll notify the charity of the
                pickup time, so they can collect it as scheduled.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-6">
              ...
              <AccordionContent className="mt-4 sm:mt-6 text-base sm:text-lg">
                All donations must meet our safety guidelines to ensure quality. Charities also
                follow safe handling procedures, keeping the food safe from pickup to delivery.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-10">
              ...
              <AccordionContent className="mt-4 sm:mt-6 text-base sm:text-lg">
                ...
                foodlinksupport@gmail.com. We’re here to support you throughout the donation
                process.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
